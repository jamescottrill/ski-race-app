...
/**
 * Competition settings: the details that place the competition on the
 * championship ladder. The publishing settings join this page when sync
 * arrives.
 */
  ...
  return (
    <PageContainer maxWidth="lg">
      <PageHeader
        ...
        subtitle="Level, season, dates and venue"
        actions={
          <Button
            variant="outline"
            onClick={handleBack}
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            The level and season place this competition on the championship
            ladder and are sent to the central results service.
          </CardDescription>
        </CardHeader>
        <CardContent>
