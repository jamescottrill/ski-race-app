    ...
    const runDetailsSection = [
      ...
      },
      {
        columns: [
          ...
          {
            width: '*',
            text: raceDetails.forerunner_1_a.trim(),
            style: 'text',
          },
        ],
        columnGap: 5,
      },
      {
        columns: [
          ...
          {
            width: '*',
            text: raceDetails.forerunner_1_b.trim(),
            style: 'text',
          },
        ],
        columnGap: 5,
      },
      {
        columns: [
          ...
          {
            width: '*',
            text: raceDetails.forerunner_1_c.trim(),
            style: 'text',
          },
        ],
        columnGap: 5,
      },
      {
        columns: [
          ...
          {
            width: '*',
            text: raceDetails.forerunner_1_d.trim(),
            style: 'text',
          },
        ],
        columnGap: 5,
    ...
    const docDefinition = {
      content: [
        ...
        ...runDetailsSection,
        {
          ...
          table: {
            headerRows: 1,
            widths: [20, 20, 30, '*', 55, 'auto', 'auto', 'auto'],
            body: [
              [
